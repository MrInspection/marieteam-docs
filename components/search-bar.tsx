      ...
      >
        <DialogTrigger asChild>
          <div className="relative flex-1 max-w-md cursor-pointer">
            <Input
              className="md:w-full rounded-md dark:bg-stone-950/95 bg-stone-50 border h-9 pr-0 sm:pr-4 text-sm shadow-sm overflow-ellipsis"
        ...
        <DialogContent className="p-0 max-w-[700px] sm:top-[38%] top-[45%] !rounded-md">
          <DialogTitle className="sr-only">SearchBar</DialogTitle>
          <DialogHeader>
            <input
              value={searchedInput}
